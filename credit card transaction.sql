...
--1 Write a query to print top 5 cities with highest spends  and their percentage contribution of total credit card spending.
...
--8 Which city took least number of days to reach its 500th transaction after the first transaction in that city.
